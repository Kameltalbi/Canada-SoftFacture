...
const LABELS: Record<DocumentLangCode, DocumentPdfLabels> = {
  fr: {
    ...
    draft: 'BROUILLON',
    clientLabel: 'Client :',
    unitPriceHtCol: 'PU HT',
    vatPercentCol: 'TVA %',
    lineTotalInclTax: 'TTC',
    creditNoteLinePrefix: 'Avoir —',
    creditNoteOnInvoice: (n) => `Avoir sur facture ${n}`,
  },
  en: {
    invoice: 'INVOICE',
    ...
    unitPriceHtCol: 'Unit excl.',
    vatPercentCol: 'VAT %',
    lineTotalInclTax: 'Incl. tax',
    creditNoteLinePrefix: 'Credit —',
